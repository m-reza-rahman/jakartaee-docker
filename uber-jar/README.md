...
* You should explore the Dockerfile in this directory used to build the Docker image. It starts from the `openjdk:11-jre-alpine` image, adds the `jakartaee-cafe.jar` from the current directory into the Docker image and runs the jar. 
